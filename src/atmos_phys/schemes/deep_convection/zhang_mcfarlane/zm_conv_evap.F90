...
!------------------------------Arguments--------------------------------
    ...
    real(r8),intent(in) :: ke, ke_lnd                        ! evaporation efficiencies
    logical,intent(in) :: zm_org                             ! land/ocean tuning selector
...
end module ap_zm_conv_evap_scheme
