module ap_modal_aero_depvel_part_scheme

  use shr_kind_mod, only : r8 => shr_kind_r8
  implicit none
  private

  public :: modal_aero_depvel_part_run

contains

  !> \section arg_table_modal_aero_depvel_part_run Argument Table
...
!       non-vegetated surface
    ...
    return
  end subroutine modal_aero_depvel_part_run

end module ap_modal_aero_depvel_part_scheme
