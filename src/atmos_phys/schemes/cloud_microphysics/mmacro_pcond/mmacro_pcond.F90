...
!> \section arg_table_mmacro_pcond_run Argument Table
!! \htmlinclude mmacro_pcond_run.html
   subroutine mmacro_pcond_run( lchnk      , ncol       , dt         , p            , dp         ,              &
   ...
   real(r8), pointer, intent(in) :: cmfr_det(:,:)           ! (pcols,pver)  Detrained mass flux from the convection scheme
