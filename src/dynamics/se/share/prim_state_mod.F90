...
#define SE_MISC_LABEL 'prim_printstate_init'
    interface
       function prim_printstate_init_codon(tag) result(tag_out) bind(c, name='prim_printstate_init_codon')
         import :: c_int64_t
         integer(c_int64_t), value :: tag
         integer(c_int64_t) :: tag_out
       end function prim_printstate_init_codon
    end interface
    ...
    if (.not. rt_codon_proof_seen .and. &
       ...
       rt_codon_tag_out = prim_printstate_init_codon(int(SE_MISC_TAG, c_int64_t))
