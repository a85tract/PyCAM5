...
logical :: use_native_ebert_curry_init_impl = .false.
logical :: ebert_curry_init_impl_selected = .false.
...
subroutine ebert_curry_init_select_impl()
   ...
   if (status == 0 .and. n > 0) then
      ...
      use_native_ebert_curry_init_impl = .false.
   endif

   ebert_curry_init_impl_selected = .true.
...
end subroutine ebert_curry_init_select_impl

!==============================================================================

subroutine ebert_curry_init_log_entered()

   use cam_logfile, only: iulog
   use spmd_utils, only: masterproc

   if (ebert_curry_init_entered_logged) return
...
end subroutine ebert_curry_init_log_entered
