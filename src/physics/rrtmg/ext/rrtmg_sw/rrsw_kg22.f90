...
!-----------------------------------------------------------------
      ...
      real(kind=r8), target :: kao(9,5,13,no22)
      real(kind=r8), target :: kbo(5,13:59,no22)
      real(kind=r8), target :: selfrefo(10,no22), forrefo(3,no22)
      real(kind=r8), target :: sfluxrefo(no22,9)
