...
!-----------------------------------------------------------------
      ...
      real(kind=r8), target :: kao(9,5,13,no18)
      real(kind=r8), target :: kbo(5,13:59,no18)
      real(kind=r8), target :: selfrefo(10,no18), forrefo(3,no18)
      real(kind=r8), target :: sfluxrefo(no18,9)
