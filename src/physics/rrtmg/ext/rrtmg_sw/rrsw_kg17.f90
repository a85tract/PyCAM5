...
!-----------------------------------------------------------------
      ...
      real(kind=r8), target :: kao(9,5,13,no17)
      real(kind=r8), target :: kbo(5,5,13:59,no17)
      real(kind=r8), target :: selfrefo(10,no17), forrefo(4,no17)
      real(kind=r8), target :: sfluxrefo(no17,5)
