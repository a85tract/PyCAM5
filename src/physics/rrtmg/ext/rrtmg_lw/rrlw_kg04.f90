...
!-----------------------------------------------------------------
      ...
      real(kind=r8), target :: fracrefao(no4,9)  ,fracrefbo(no4,6)
      real(kind=r8), target :: kao(9,5,13,no4)
      real(kind=r8), target :: kbo(5,5,13:59,no4)
      real(kind=r8), target :: selfrefo(10,no4)  ,forrefo(4,no4)
