...
@export
def uwshcu_output_diag_init_stage_dispatch_codon(
    mix: int,
    mkx: int,
    iend: int,
    ncnst: int,
...
def uwshcu_output_diag_init_shell_codon(
    ...
    uwshcu_output_diag_init_stage_dispatch_codon(
        mix,
        mkx,
        iend,
        ncnst,
...
@export
def uwshcu_main_diag_post_all_stage_dispatch_codon(
    mix: int,
    mkx: int,
    i_col: int,
    ncnst: int,
...
def uwshcu_main_diag_post_all_shell_codon(
    ...
    uwshcu_main_diag_post_all_stage_dispatch_codon(
        mix,
        mkx,
        i_col,
        ncnst,
...
@export
def uwshcu_exit_zero_all_stage_dispatch_codon(
    mix: int,
    mkx: int,
    i_col: int,
    ncnst: int,
...
def uwshcu_exit_zero_all_shell_codon(
    ...
    uwshcu_exit_zero_all_stage_dispatch_codon(
        mix,
        mkx,
        i_col,
        ncnst,
...
@export
def uwshcu_iter_restore_all_stage_dispatch_codon(
    mix: int,
    mkx: int,
    i_col: int,
    ncnst: int,
...
def uwshcu_iter_restore_all_shell_codon(
    ...
    uwshcu_iter_restore_all_stage_dispatch_codon(
        mix,
        mkx,
        i_col,
        ncnst,
...
@export
def uwshcu_pbl_precheck_source_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
    pblh: float,
...
def uwshcu_pbl_precheck_source_shell_codon(
    ...
    uwshcu_pbl_precheck_source_stage_dispatch_codon(
        mkx,
        ncnst,
        wtrc_nwset,
        pblh,
...
def uwshcu_interface_thv_shell_codon(
    ...
    uwshcu_interface_thv_stage_dispatch_codon(
        k_fortran,
        zvir,
        thj,
        qvj,
...
@export
def uwshcu_interface_conden_exit_stage_dispatch_codon(
    id_check: int,
    exit_conden_p: cobj,
    exit_code_p: cobj,
):
...
def uwshcu_interface_conden_exit_shell_codon(
    ...
    uwshcu_interface_conden_exit_stage_dispatch_codon(
        id_check,
        exit_conden_p,
        exit_code_p,
    )
...
def uwshcu_release_scaleh_batch_shell_codon(
    ...
    uwshcu_release_scaleh_stage_dispatch_codon(
        kind,
        mkx,
        kinv,
        klcl,
...
@export
def uwshcu_release_env_scaleh_iter_init_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
    iter_scaleh: int,
...
def uwshcu_release_env_scaleh_iter_init_shell_codon(
    ...
    uwshcu_release_env_scaleh_iter_init_stage_dispatch_codon(
        mkx,
        ncnst,
        wtrc_nwset,
        iter_scaleh,
...
@export
def uwshcu_scaleh_filter_penent_flux_comp_sub_prep_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
    kinv: int,
...
@export
def uwshcu_comp_sub_conden_exit_stage_dispatch_codon(
    id_check: int,
    exit_code_p: cobj,
):
    exit_code = Ptr[int](exit_code_p)
...
@export
def uwshcu_thermo_conden_condensate_stage_dispatch_codon(
    kind: int,
    k_fortran: int,
    mkx: int,
    ixnumliq: int,
...
@export
def uwshcu_thermo_emf_kbup_conden_shell_codon(
    k_fortran: int,
    mkx: int,
    ixnumliq: int,
    ixnumice: int,
    ...
    qi_emf_kbup = Ptr[float](qi_emf_kbup_p)
...
@export
def uwshcu_comp_sub_sink_thermo_prelim_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
    kpen: int,
...
def uwshcu_comp_sub_sink_thermo_prelim_shell_codon(
    ...
    uwshcu_comp_sub_sink_thermo_prelim_stage_dispatch_codon(
        mkx,
        ncnst,
        wtrc_nwset,
        kpen,
...
@export
def uwshcu_thermo_final_precip_bulk_init_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
    k_fortran: int,
...
def uwshcu_thermo_final_precip_bulk_init_shell_codon(
    ...
    uwshcu_thermo_final_precip_bulk_init_stage_dispatch_codon(
        mkx,
        ncnst,
        wtrc_nwset,
        k_fortran,
...
@export
def uwshcu_cloud_diag_batch_stage_dispatch_codon(
    kind: int,
    mkx: int,
    k_fortran: int,
    krel: int,
    ...
    if kind == 0:
        ...
        cloud_qlj0 = Ptr[float](cloud_qlj0_p)
        cloud_qij0 = Ptr[float](cloud_qij0_p)
        cloud_qlj0[0] = qlj_v
        cloud_qij0[0] = qij_v
    elif kind == 1:
        exit_code = Ptr[int](exit_code_p)
        ...
        cloud_qlj0 = Ptr[float](cloud_qlj0_p)
        cloud_qij0 = Ptr[float](cloud_qij0_p)
        uwshcu_cloud_diag_all_shell_codon(
            mkx,
            krel,
            kpen,
            cloud_qlj0[0],
...
@export
def uwshcu_cloud_diag_batch_shell_codon(
    kind: int,
    mkx: int,
    k_fortran: int,
    krel: int,
...
@export
def uwshcu_post_positive_tracer_limiter_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    g_v: float,
    dt_v: float,
...
def uwshcu_post_positive_tracer_limiter_shell_codon(
    ...
    uwshcu_post_positive_tracer_limiter_stage_dispatch_codon(
        mkx,
        ncnst,
        g_v,
        dt_v,
...
@export
def uwshcu_precip_surface_positive_prep_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
    kpen: int,
...
def uwshcu_precip_surface_positive_prep_shell_codon(
    ...
    uwshcu_precip_surface_positive_prep_stage_dispatch_codon(
        mkx,
        ncnst,
        wtrc_nwset,
        kpen,
...
@export
def uwshcu_precip_bulk_init_stage_dispatch_codon(
    mkx: int,
    wtrc_nwset: int,
    trace_water: int,
    rainflx: float,
...
def uwshcu_precip_bulk_init_shell_codon(
    ...
    uwshcu_precip_bulk_init_stage_dispatch_codon(
        mkx,
        wtrc_nwset,
        trace_water,
        rainflx,
...
@export
def uwshcu_precip_bulk_layer_stage_dispatch_codon(
    mkx: int,
    mix: int,
    i: int,
    k: int,
...
def uwshcu_precip_bulk_layer_shell_codon(
    ...
    uwshcu_precip_bulk_layer_stage_dispatch_codon(
        mkx,
        mix,
        i,
        k,
...
@export
def uwshcu_thermo_post_stage_dispatch_codon(
    kind: int,
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
...
def uwshcu_thermo_post_batch_shell_codon(
    ...
    uwshcu_thermo_post_stage_dispatch_codon(
        kind,
        mkx,
        ncnst,
        wtrc_nwset,
...
@export
def uwshcu_column_thermo_slope_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
    xlv: float,
...
def uwshcu_column_thermo_slope_shell_codon(
    ...
    uwshcu_column_thermo_slope_stage_dispatch_codon(
        mkx,
        ncnst,
        wtrc_nwset,
        xlv,
...
@export
def uwshcu_column_input_load_stage_dispatch_codon(
    mix: int,
    mkx: int,
    i_col: int,
    ncnst: int,
...
def uwshcu_column_input_load_shell_codon(
    ...
    uwshcu_column_input_load_stage_dispatch_codon(
        mix,
        mkx,
        i_col,
        ncnst,
...
@export
def uwshcu_column_init_all_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
    qv0_p: cobj,
...
def uwshcu_column_init_all_shell_codon(
    ...
    uwshcu_column_init_all_stage_dispatch_codon(
        mkx,
        ncnst,
        wtrc_nwset,
        qv0_p,
...
@export
def uwshcu_iter_save_all_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
    kinv: int,
...
def uwshcu_iter_save_all_shell_codon(
    ...
    uwshcu_iter_save_all_stage_dispatch_codon(
        mkx,
        ncnst,
        wtrc_nwset,
        kinv,
...
@export
def uwshcu_delcin_restore_reset_all_stage_dispatch_codon(
    mkx: int,
    ncnst: int,
    wtrc_nwset: int,
    use_cincin: int,
...
def uwshcu_delcin_restore_reset_all_shell_codon(
    ...
    uwshcu_delcin_restore_reset_all_stage_dispatch_codon(
        mkx,
        ncnst,
        wtrc_nwset,
        use_cincin,
...
@export
def uwshcu_inv_prep_stage_dispatch_codon(
    mix: int,
    mkx: int,
    iend: int,
    ncnst: int,
...
def uwshcu_inv_prep_shell_codon(
    ...
    uwshcu_inv_prep_stage_dispatch_codon(
        mix,
        mkx,
        iend,
        ncnst,
...
@export
def uwshcu_inv_post_stage_dispatch_codon(
    mix: int,
    mkx: int,
    iend: int,
    ncnst: int,
...
def uwshcu_inv_post_shell_codon(
    ...
    uwshcu_inv_post_stage_dispatch_codon(
        mix,
        mkx,
        iend,
        ncnst,
...
@export
def convect_shallow_outer_stage_dispatch_codon(
    stage: int,
    mode: int,
    ncol: int,
    pcols: int,
    ...
    if stage == 1:
        convect_shallow_init_shell_codon(ncol, pcols, p1, p2)
    elif stage == 2:
        convect_shallow_ptend_lq_mask_shell_codon(pcnst, p1)
    elif stage == 3:
        convect_shallow_wtrc_precip_shell_codon(pcols, vap_idx, p1, p2, p3, p4)
    elif stage == 4:
        convect_shallow_diag_shell_codon(
            mode,
            ncol,
            pcols,
            pver,
        ...
        convect_shallow_uw_post_shell_codon(
            ncol,
            pcols,
            pver,
            pverp,
