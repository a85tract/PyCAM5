...
@export
def aero_model_wetdep_inputs_cldst_codon(
    cam5_flag: int,
    ncol: int,
    pcols: int,
    pver: int,
...
@export
def aero_model_wetdep_mode_phase_stage_dispatch_codon(
    m: int,
    lphase: int,
    ncol: int,
    pcols: int,
    ...
    aero_model_wetdep_mode_phase_codon(
        m,
        lphase,
        ncol,
        pcols,
        ...
        isprx_mask_p,
        dgnumwet_p,
        scavimptblnum_mode_p,
        scavimptblvol_mode_p,
        state_q_p,
        ptend_q_p,
        qaerwat_mode_p,
        fracis_full_p,
...
@export
def modal_aero_gasaerexch_sub_shell_codon(
    stage: int,
    ncol: int,
    pcols: int,
    pver: int,
...
@export
def modal_aero_gasaerexch_sub_fullshell_codon(
    ncol: int,
    pcols: int,
    pver: int,
    pcnstxx: int,
    ...
    modefrm_renamexf_p: cobj,
    modetoo_renamexf_p: cobj,
    nspec_amode_rename_p: cobj,
    lspectype_amode_rename_p: cobj,
    specmw_amode_rename_p: cobj,
    specdens_amode_rename_p: cobj,
    lmassptr_amode_rename_p: cobj,
    lmassptrcw_amode_rename_p: cobj,
    numptr_amode_rename_p: cobj,
    numptrcw_amode_rename_p: cobj,
    dgnum_amode_rename_p: cobj,
    factoraa_rename_p: cobj,
    factoryy_rename_p: cobj,
    dryvol_smallest_rename_p: cobj,
    v2nlorlx_rename_p: cobj,
    v2nhirlx_rename_p: cobj,
    factor_3alnsg2_rename_p: cobj,
    dp_cut_rename_p: cobj,
    lndp_cut_rename_p: cobj,
    dp_belowcut_rename_p: cobj,
    dp_xfernone_threshaa_rename_p: cobj,
    dp_xferall_thresh_rename_p: cobj,
    igrow_shrink_renamexf_p: cobj,
    ixferable_all_renamexf_p: cobj,
    ixferable_a_renamexf_p: cobj,
    ixferable_c_renamexf_p: cobj,
    ...
    for k in range(1, pver + 1):
        for i in range(1, ncol + 1):
            dorename_atik[_idx2(i, k, ncol)] = 1

    for l in range(1, pcnstxx + 1):
        dotendrn[l - 1] = 0
        dotendqqcwrn[l - 1] = 0

    modal_aero_gasaerexch_sub_shell_codon(
        100,
        ncol,
        pcols,
        pver,
    ...
    modal_aero_gasaerexch_sub_postshell_codon(
        ncol,
        pcols,
        pver,
        pcnstxx,
        ...
        modefrm_renamexf_p,
        modetoo_renamexf_p,
        nspec_amode_rename_p,
        lspectype_amode_rename_p,
        specmw_amode_rename_p,
        specdens_amode_rename_p,
        lmassptr_amode_rename_p,
        lmassptrcw_amode_rename_p,
        numptr_amode_rename_p,
        numptrcw_amode_rename_p,
        dgnum_amode_rename_p,
        factoraa_rename_p,
        factoryy_rename_p,
        dryvol_smallest_rename_p,
        v2nlorlx_rename_p,
        v2nhirlx_rename_p,
        factor_3alnsg2_rename_p,
        dp_cut_rename_p,
        lndp_cut_rename_p,
        dp_belowcut_rename_p,
        dp_xfernone_threshaa_rename_p,
        dp_xferall_thresh_rename_p,
        igrow_shrink_renamexf_p,
        ixferable_all_renamexf_p,
        ixferable_a_renamexf_p,
        ixferable_c_renamexf_p,
...
@export
def modal_aero_coag_prep_fullshell_codon(
    ncol: int,
    pcols: int,
    pver: int,
    pcnstxx: int,
    ...
    modal_aero_coag_getcoags_prep_codon(
        ncol,
        pcols,
        pver,
        top_lev,
    ...
    modal_aero_coag_sub_fullshell_codon(
        ncol,
        pcols,
        pver,
        pcnstxx,
...
@export
def modal_aero_coag_sub_fullshell_codon(
    ncol: int,
    pcols: int,
    pver: int,
    pcnstxx: int,
