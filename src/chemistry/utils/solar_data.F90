...
!-----------------------------------------------------------------------
  subroutine solar_data_readnl( nlfile )
    ...
    call mpibcast(solar_data_file, len(solar_data_file), mpichar, 0, mpicom)
    call mpibcast(solar_data_type, len(solar_data_type), mpichar, 0, mpicom)
    call mpibcast(solar_data_ymd,  1,                    mpiint,  0, mpicom)
    call mpibcast(solar_data_tod,  1,                    mpiint,  0, mpicom)
    call mpibcast(solar_const,     1,                    mpir8 ,  0, mpicom)
    call mpibcast(solar_htng_spctrl_scl,1,               mpilog,  0, mpicom)
#endif
