...
#define CAM_MISC_LABEL 'get_hist_coord_index'
    interface
       function get_hist_coord_index_codon(tag) result(tag_out) bind(c, name='get_hist_coord_index_codon')
         import :: c_int64_t
         integer(c_int64_t), value :: tag
         integer(c_int64_t) :: tag_out
       end function get_hist_coord_index_codon
    end interface
    ...
    if (.not. rt_codon_proof_seen .and. &
       ...
       rt_codon_tag_out = get_hist_coord_index_codon(int(CAM_MISC_TAG, c_int64_t))
...
#define CAM_MISC_LABEL 'add_vert_coord'
    interface
       function add_vert_coord_codon(tag) result(tag_out) bind(c, name='add_vert_coord_codon')
         import :: c_int64_t
         integer(c_int64_t), value :: tag
         integer(c_int64_t) :: tag_out
       end function add_vert_coord_codon
    end interface
    ...
    if (.not. rt_codon_proof_seen .and. &
         .not. (rt_codon_status == 0 .and. rt_codon_n > 0 .and. &
         trim(adjustl(rt_codon_impl_name(:rt_codon_n))) == 'native')) then
       rt_codon_tag_out = add_vert_coord_codon(int(CAM_MISC_TAG, c_int64_t))
       if (rt_codon_tag_out /= int(CAM_MISC_TAG, c_int64_t)) then
          write(iulog,*) 'cam_misc_touch_codon tag roundtrip failed'
          stop 2
       endif
...
#define CAM_MISC_LABEL 'write_hist_coord_attrs'
    interface
       function write_hist_coord_attrs_codon(tag) result(tag_out) bind(c, name='write_hist_coord_attrs_codon')
         import :: c_int64_t
         integer(c_int64_t), value :: tag
         integer(c_int64_t) :: tag_out
       end function write_hist_coord_attrs_codon
    end interface
    ...
    if (.not. rt_codon_proof_seen .and. &
         .not. (rt_codon_status == 0 .and. rt_codon_n > 0 .and. &
         trim(adjustl(rt_codon_impl_name(:rt_codon_n))) == 'native')) then
       rt_codon_tag_out = write_hist_coord_attrs_codon(int(CAM_MISC_TAG, c_int64_t))
       if (rt_codon_tag_out /= int(CAM_MISC_TAG, c_int64_t)) then
          write(iulog,*) 'cam_misc_touch_codon tag roundtrip failed'
          stop 2
       endif
...
#define CAM_MISC_LABEL 'write_hist_coord_vars'
    interface
       function write_hist_coord_vars_codon(tag) result(tag_out) bind(c, name='write_hist_coord_vars_codon')
         import :: c_int64_t
         integer(c_int64_t), value :: tag
         integer(c_int64_t) :: tag_out
       end function write_hist_coord_vars_codon
    end interface
    ...
    if (.not. rt_codon_proof_seen .and. &
         .not. (rt_codon_status == 0 .and. rt_codon_n > 0 .and. &
         trim(adjustl(rt_codon_impl_name(:rt_codon_n))) == 'native')) then
       rt_codon_tag_out = write_hist_coord_vars_codon(int(CAM_MISC_TAG, c_int64_t))
       if (rt_codon_tag_out /= int(CAM_MISC_TAG, c_int64_t)) then
          write(iulog,*) 'cam_misc_touch_codon tag roundtrip failed'
          stop 2
       endif
