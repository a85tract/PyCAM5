...
!            it is not supported.  
  ...
  namelist /cam_inparm/ ncdata, bnd_topo, &
                    ...
                    fincl7lonlat,fincl8lonlat,fincl9lonlat,fincl10lonlat, &
                    collect_column_output, &
                    fincl1, fincl2, fincl3, fincl4, fincl5, fincl6, fincl7, fincl8, fincl9, fincl10, &
                    fexcl1, fexcl2, fexcl3, fexcl4, fexcl5, fexcl6, fexcl7, fexcl8, fexcl9, fexcl10, &
                    hfilename_spec, &
                    fwrtpr1,fwrtpr2,fwrtpr3,fwrtpr4,fwrtpr5,fwrtpr6, fwrtpr7,fwrtpr8,fwrtpr9,fwrtpr10,&
                    dtime, &
                    nlvdry,  &
                    pertlim ,&
