...
#define CAM_MISC_LABEL 'spmd_utils_readnl'
    interface
       function spmd_utils_readnl_codon(tag) result(tag_out) bind(c, name='spmd_utils_readnl_codon')
         import :: c_int64_t
         integer(c_int64_t), value :: tag
         integer(c_int64_t) :: tag_out
       end function spmd_utils_readnl_codon
    end interface
    ...
    if (.not. rt_codon_proof_seen .and. &
       ...
       rt_codon_tag_out = spmd_utils_readnl_codon(int(CAM_MISC_TAG, c_int64_t))
