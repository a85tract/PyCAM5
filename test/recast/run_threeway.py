...
def main() -> int:
    ...
    entries = [
        {
            "routine": NAME,
            "comparison": f"{label} vs native Fortran",
    ...
    entries.append(
        {
            "routine": NAME,
            "comparison": "engine vs codon",
            "verifier": "direct",
            "confidence": "bit_exact" if agree.startswith("bit-identical") else "failed",
            "passed": agree.startswith("bit-identical"),
            "detail": agree,
        }
    )
